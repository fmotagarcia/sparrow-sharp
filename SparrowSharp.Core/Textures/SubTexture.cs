...
namespace Sparrow.Textures
{
    ...
    public class SubTexture : Texture
    {
        ...
        private Matrix _transformationMatrixToRoot;
        ...
        private void UpdateMatrices()
        {
            ...
            else _transformationMatrix = Matrix.Create();

            if (_transformationMatrixToRoot != null) _transformationMatrixToRoot.Identity();
            else _transformationMatrixToRoot = Matrix.Create();
        ...
        public override Matrix TransformationMatrix { get { return _transformationMatrix; } }

        public override Matrix TransformationMatrixToRoot { get { return _transformationMatrixToRoot; } }

        override public int Base { get { return _parent.Base; } }
